...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UsageRecordedEvent> kafkaListenerContainerFactory(
            ConsumerFactory<String, UsageRecordedEvent> consumerFactory) {
